    ...
    <section id="haircare" className="py-16 md:py-24 bg-gradient-to-b from-white to-[#4FD1C5]/5">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl group w-full bg-white flex justify-center">
              <img
                src={image01}
                alt="PantioSalon Products"
                className="w-full h-auto max-h-[800px] object-contain group-hover:scale-105 transition-transform duration-700"
              />
